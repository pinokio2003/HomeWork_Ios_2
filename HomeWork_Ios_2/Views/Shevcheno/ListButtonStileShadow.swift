//
//  ListButtonStileShadow.swift
//  HomeWork_Ios_2
//
//  Created by Anatolii Kravchuk on 24.02.2023.
//

import UIKit

class ListButtonStileShadow: UIButton{
    ...
    override init(frame: CGRect) {
        ...
        buttonStile.setImage(UIImage(systemName: "arrowshape.turn.up.right"), for: .normal)
        buttonStile.backgroundColor = .listColor
